...
exports.initialize = () => __awaiter(void 0, void 0, void 0, function* () {
    connectionPool = yield oracledb_1.createPool(database_1.default);
});
// Closing the database
exports.close = () => __awaiter(void 0, void 0, void 0, function* () {
    connectionPool ? yield connectionPool.close() : connectionPool;
});
// Execute the query
exports.simpleExecutePlSql = (statement, binds = [], opts = {}) => __awaiter(void 0, void 0, void 0, function* () {
    let conn = null;
...
exports.resultSetExecute = (statement, binds = [], opts = {}) => __awaiter(void 0, void 0, void 0, function* () {
    let conn = null;
    opts.resultSet = true;
    opts.outFormat = oracledb_1.OUT_FORMAT_OBJECT;
    try {
...
exports.executeManyPlSql = (statement, binds = [], opts = {}) => __awaiter(void 0, void 0, void 0, function* () {
    let conn = null;
    try {
        conn = yield connectionPool.getConnection();
